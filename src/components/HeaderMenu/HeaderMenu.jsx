...
const HeaderMenu = ({ title, headerId }) => {
  ...
  return (
    <div className="fixed w-full lg:h-[235px] md:h-[235px] h-[175px] shadow-md z-50 bg-white">
      ...
      <div className="fixed lg:top-[150px] md:top-[150px] top-[105px] lg:left-1/2 lg:-translate-x-1/2 lg:w-[968px] md:w-[900px] w-[330px] py-2 px-4 flex items-center lg:gap-3 md:gap-3 gap:2">
        <div
